#!/usr/bin/env python3
"""
Build a LaTeX comparison table for BLINK Qwen2.5-VL-3B:
  - Default (BLINK_Qwen2.5-VL-3B-Instruct)
  - Text-only (BLINK_Qwen2.5-VL-3B-Instruct-det-text-only)
"""
...
FILE_A = PROJECT_ROOT / "test/BLINK_Qwen2.5-VL-3B-Instruct/spagent_evaluation_results_qwen_vl2d5_3b_instruct_3_all.json"
FILE_B = PROJECT_ROOT / "test/BLINK_Qwen2.5-VL-3B-Instruct-det-text-only/spagent_evaluation_results_qwen_vl2d5_3b_instruct_3_all.json"
...
def main():
    ...
    lines = [
        ...
        r"\begin{table}[htbp]",
        r"\centering",
        r"\caption{BLINK Qwen2.5-VL-3B: Default vs.\ text-only object detection encoding. Accuracy (\%); $\uparrow$/$\downarrow$ = change vs.\ default.}",
        r"\label{tab:blink-3b-compare}",
        r"\small",
        r"\resizebox{\textwidth}{!}{",
        r"\begin{tabular}{lrr}",
        r"\toprule",
        "Metric & Default & Text only \\\\",
        r"\midrule",
    ]
    ...
    out_tex = OUTPUT_DIR / "comparison_blink_3b.tex"
